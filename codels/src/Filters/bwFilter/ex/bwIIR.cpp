#include "bwIIR.hpp"
	...
	double *bwFilter::binomial_mult( int n, double *p )
	{
		int i, j;
		double *a;
	...
	double *bwFilter::trinomial_mult( int n, double *b, double *c )
	{
		int i, j;
		double *a;
	...
	double *bwFilter::dcof_bwlp( int n, double fcf )
	{
	...
	double *bwFilter::dcof_bwhp( int n, double fcf )
	{
		return( dcof_bwlp( n, fcf ) );
	}

	double *bwFilter::dcof_bwbp( int n, double f1f, double f2f )
	{
		int k;            // loop variables
	...
	double *bwFilter::dcof_bwbs( int n, double f1f, double f2f )
	{
		int k;            // loop variables
		double theta;     // M_PI * (f2f - f1f) / 2.0
		double cp;        // cosine of phi
	...
	double *bwFilter::ccof_bwbs( int n, double f1f, double f2f )
	{
		double alpha;
		double *ccof;
		int i, j;
	...
	double bwFilter::sf_bwlp( int n, double fcf )
	{
	...
	double bwFilter::sf_bwhp( int n, double fcf )
	{
		int m, k;         // loop variables
		double omega;     // M_PI * fcf
		double fomega;    // function of omega
	...
	double bwFilter::sf_bwbp( int n, double f1f, double f2f )
	{
		int k;            // loop variables
	...
	double bwFilter::sf_bwbs( int n, double f1f, double f2f )
	{
		int k;            // loop variables
